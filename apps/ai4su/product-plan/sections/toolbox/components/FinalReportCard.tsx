...
import type { FinalReportCardProps } from '../types'
...
export function FinalReportCard({ report, onDownload }: FinalReportCardProps) {
  return (
    <section className="py-12 border-t border-stone-200 dark:border-stone-800">
      <div className="bg-gradient-to-br from-[#003399] to-[#001133] rounded-2xl overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            ...
            <div className="shrink-0">
              <div className="w-24 h-24 rounded-2xl bg-white/10 flex items-center justify-center">
                <BookOpen className="w-12 h-12 text-[#F5CE2A]" />
              </div>
            </div>

            {/* Middle: Content */}
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#F5CE2A] rounded-full text-xs font-bold text-[#003399] mb-4">
            ...
            <div className="shrink-0">
              <button
                ...
                className="group inline-flex items-center gap-3 px-8 py-4 bg-[#F5CE2A] text-[#003399] font-bold rounded-xl
