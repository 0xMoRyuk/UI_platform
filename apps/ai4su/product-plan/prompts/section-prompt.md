...
- **SECTION_NAME** = [Human-readable name, e.g., "Toolbox" or "Hackathons"]
- **SECTION_ID** = [Folder name in sections/, e.g., "toolbox" or "hackathons"]
...
## Quick Reference: Section Variables

| Section | SECTION_NAME | SECTION_ID | NN |
|---------|--------------|------------|-----|
| Home | Home | home | 02 |
| Toolbox | Toolbox | toolbox | 03 |
| Hackathons | Hackathons | hackathons | 04 |
| Ecosystem | Ecosystem | ecosystem | 05 |
| Partners | Partners | partners | 06 |
